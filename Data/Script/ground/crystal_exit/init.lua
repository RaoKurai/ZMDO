...
function crystal_exit.Cutscene()
  ...
  if player.Data.BaseForm.Species == 132 then
	...
	partner.Data.BaseForm = RogueEssence.Dungeon.MonsterID(334, 0, 1, Gender.Male)
	...
	partner.Data.BaseForm = RogueEssence.Dungeon.MonsterID(172, 0, 1, Gender.Male)
	...
	partner.Data.BaseForm = RogueEssence.Dungeon.MonsterID(179, 0, 1, Gender.Male)
